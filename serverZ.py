...
def response_builder(success = True, message = "Respon telah sukses!", data = None):
    return jsonify({
        'success': success,
        'message': message,
        'data': data
...
def get_sensor(sensor_name):
    ...
    message = "data sensor milik Ahmad Zakaria Ummaan berhasil dikirim!" if data is not None else "sensor tidak mempunyai data!"
